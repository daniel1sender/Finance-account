...
func TestMakeTransfer(t *testing.T) {
	...
	t.Run("Should return transfersMap when amount is greater than zero", func(t *testing.T) {
	...
	t.Run("Should return a empty map when amount is less or equal zero", func(t *testing.T) {
